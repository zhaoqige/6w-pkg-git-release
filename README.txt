...
If you want to be collaborator, let me know.
...
4.2 or for dev purpose, try "cd /openwrt; make package/grid-lite/compile", 
and upload "/openwrt/bin/ar71xx/packages/grid-lite_*_ar71xx.ipk", 
then test its functions.
